...
AlarmEditScreen::AlarmEditScreen()
{
    m_screen = lv_obj_create(NULL);
    m_clockEditWidget = new ClockEditWidget(m_screen, 12, 0);
    ...
    static const char * map[] = {LV_SYMBOL_UP, "\n", 
    "1", "\n", 
    "2", "\n", 
    "3", "\n", 
    "4", "\n", 
    ...
    //lv_obj_center(btnm);
    lv_obj_align(btnm, LV_ALIGN_LEFT_MID, 30, 0);
}